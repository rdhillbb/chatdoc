...
# Main function to run the Streamlit app
    ...
    # Process and display response to user input
        if send_button and user_input:
            ...
            st.write(f'<p style="color: red;">Error: {e}</p>', unsafe_allow_html=True)  # Print error in red to window
            st.write('<p style="color: blue;">Please check the backend server.</p>', unsafe_allow_html=True)  # Print in blue
            quit()
